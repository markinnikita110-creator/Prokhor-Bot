TEXTS = {
    "en": {
        ...
        "tariff_compare": (
            ...
            "📦 START — free\n"
            "✅ Up to 5 clients\n"
            "✅ Up to 2 groups/cohorts (15 members each)\n"
            "✅ Notes, SOAP, homework\n"
            "✅ Check-ins and auto check-ins\n"
            "✅ Recurring sessions\n"
            "✅ Reminders 24h and 1h before sessions\n"
            "✅ Analytics for the last 30 days\n"
            "❌ Data export\n"
            "❌ Supervision logbook\n"
            "❌ Client self-booking\n\n"
            "💎 PRO — via promo code · 🔥 most popular\n"
            "Everything in Start, plus:\n"
            "✅ Unlimited clients\n"
            "✅ Up to 10 cohorts, up to 50 members each\n"
            "✅ Full analytics history, no limits\n"
            "✅ Export notes and sessions (TXT/CSV)\n"
            "✅ Supervision logbook\n"
            "✅ Client self-booking via personal link\n\n"
            "🚀 PRO+ — coming soon\n"
            "Everything in Pro, plus:\n"
            "🤖 AI assistant — turn voice notes into SOAP records,\n"
            "   session briefs, smart search across your notes, and more\n\n"
            "Activate Pro: /promo"
        ),
        "tariff_howto": (
            "❓ *How does it work?*\n\n"
    ...
    "ru": {
        ...
        "tariff_compare": (
            ...
            "📦 START — бесплатно\n"
            "✅ До 5 клиентов\n"
            "✅ До 2 групп/когорт (15 участников в каждой)\n"
            "✅ Заметки, SOAP, домашние задания\n"
            "✅ Чек-ины и авточек-ины\n"
            "✅ Регулярные сессии\n"
            ...
            "❌ Супервизия\n"
            "❌ Самозапись клиентов\n\n"
            "💎 PRO — по промокоду · 🔥 выбирают чаще всего\n"
            "Всё из Start, плюс:\n"
            "✅ Безлимит клиентов\n"
            "✅ До 10 когорт, до 50 участников в каждой\n"
            "✅ Полная история аналитики без ограничений\n"
            "✅ Экспорт заметок и сессий (TXT/CSV)\n"
            "✅ Журнал супервизии\n"
            "✅ Самозапись клиентов по личной ссылке\n\n"
            "🚀 PRO+ — совсем скоро\n"
            "Всё из Pro, плюс:\n"
            "🤖 AI-ассистент — голосовая заметка станет SOAP-записью,\n"
            "   бриф перед сессией, умный поиск по заметкам и многое другое\n\n"
            "Активировать Pro: /promo"
        ),
        "tariff_howto": (
            "❓ *Как это работает?*\n\n"
