TEXTS = {
    "en": {
        ...
        "is_sessions_title":      "📅 Sessions for {client}:",
        "is_sessions_empty":      "No upcoming sessions for {client}.",
        "is_btn_add_oneoff":      "➕ One-off session",
        "is_btn_add_recurring":   "🔁 Set up recurring",
        "is_btn_back_list":       "⬅️ Back to list",
        "is_not_found":           "Session not found.",
        ...
        "is_btn_clear":           "🗑 Clear",
        "is_ask_datetime":        "Enter date and time in your local timezone (YYYY-MM-DD HH:MM):",
        "is_ask_datetime_new":    "Enter new date and time (YYYY-MM-DD HH:MM):",
        "is_ask_topic_new":       "Enter topic (or skip):",
        "is_ask_link_new":        "Enter link (or skip / clear):",
        "is_updated_dt":          "✅ Date/time updated.",
        "is_updated_topic":       "✅ Topic updated.",
        "is_updated_link":        "✅ Link updated.",
        "is_delete_confirm":      "Delete session on {date}?",
        "is_delete_yes":          "🗑 Delete",
        "is_delete_no":           "❌ Cancel",
        "is_deleted_ok":          "✅ Session deleted.",
        "is_paused_ok":           "⏸ Recurrence paused for {client}.",
        "is_resumed_ok":          "▶️ Recurrence resumed for {client}.",
        "is_delrule_confirm":     "Delete recurrence rule for {client}?\nAlready-scheduled sessions stay, no new ones will be created.",
        "is_delrule_yes":         "🚫 Delete rule",
        "is_delrule_no":          "❌ Cancel",
        "is_delrule_ok":          "✅ Recurrence rule deleted.",
        "is_recurring_ask_days":  "Pick the weekdays this session repeats on, then press Done:",
        "is_recurring_days_empty":"Pick at least one weekday first.",
        "is_recurring_ask_time":  "Enter session time in your local timezone (HH:MM):",
        "is_recurring_created":   "✅ Recurring session set up\nClient: {client}\nDays: {days}\n🕐 {time}\nUpcoming sessions for the next 30 days scheduled automatically.",
        "is_session_created":     "✅ Session scheduled for {client}\n📅 {date}",
        "err_invalid_datetime":   "Invalid format. Please use YYYY-MM-DD HH:MM (e.g. 2025-03-15 14:30).",
        "err_invalid_time":       "Invalid format. Please use HH:MM (e.g. 14:30).",
    ...
    "ru": {
        ...
        "is_ask_datetime":        "Введите дату и время в вашем часовом поясе (ГГГГ-ММ-ДД ЧЧ:ММ):",
        "is_ask_datetime_new":    "Введите новые дату и время (ГГГГ-ММ-ДД ЧЧ:ММ):",
        "is_ask_topic_new":       "Введите тему (или пропустите):",
        "is_ask_link_new":        "Введите ссылку (или пропустите / очистите):",
        "is_updated_dt":          "✅ Дата/время обновлены.",
        "is_updated_topic":       "✅ Тема обновлена.",
        "is_updated_link":        "✅ Ссылка обновлена.",
        "is_delete_confirm":      "Удалить сессию {date}?",
        "is_delete_yes":          "🗑 Удалить",
        "is_delete_no":           "❌ Отмена",
        "is_deleted_ok":          "✅ Сессия удалена.",
        "is_paused_ok":           "⏸ Повтор приостановлен для {client}.",
        "is_resumed_ok":          "▶️ Повтор возобновлён для {client}.",
        ...
        "is_recurring_ask_days":  "Выберите дни недели, затем нажмите Готово:",
        "is_recurring_days_empty":"Сначала выберите хотя бы один день недели.",
        "is_recurring_ask_time":  "Введите время сессии в вашем часовом поясе (ЧЧ:ММ):",
        "is_recurring_created":   "✅ Повтор настроен\nКлиент: {client}\nДни: {days}\n🕐 {time}\nБудущие сессии на 30 дней уже запланированы.",
        "is_session_created":     "✅ Сессия запланирована для {client}\n📅 {date}",
        "err_invalid_datetime":   "Неверный формат. Используйте ГГГГ-ММ-ДД ЧЧ:ММ (например, 2025-03-15 14:30).",
        "err_invalid_time":       "Неверный формат. Используйте ЧЧ:ММ (например, 14:30).",
